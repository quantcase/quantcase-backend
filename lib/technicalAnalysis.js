...
class TechnicalAnalysis {
  ...
  async fetchMarketData(symbol) {
    ...
    let allTimeLow  = null;
    let allTimeHighDate = null;
    let allTimeLowDate  = null;
    if (allTimeBars.length > 0) {
      const athBar = allTimeBars.reduce((a, b) => b.high > a.high ? b : a);
      const atlBar = allTimeBars.reduce((a, b) => b.low  < a.low  ? b : a);
      allTimeHigh     = athBar.high;
      allTimeLow      = atlBar.low;
      allTimeHighDate = athBar.date;
      allTimeLowDate  = atlBar.date;
    }

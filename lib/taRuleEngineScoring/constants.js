...
/**
 * Round price values:
 * - If value >= 100: round to whole integer (e.g. 740, 5800)
 * - If value < 100: round to up to 2 decimal places (e.g. 45.25, 8.5)
 *
...
/**
 * Format price for inclusion in plain-English narrative strings.
 * - If value >= 100: whole integer string (e.g. "5800")
 * - If value < 100: string with up to 2 decimal places (e.g. "45.25", "8.5")
 *
 * @param {number|null|undefined} val
 * @returns {string}
 */

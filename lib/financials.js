...
class Financials {
  ...
  async _buildMetrics(annualPeriods, resCtx) {
    const [revValues, profitValues, roeValues, ttmRevSeries, ttmPatSeries, { '1y': stockCagr1y, '3y': stockCagr3y, '5y': stockCagr5y, '10y': stockCagr10y }] = await Promise.all([

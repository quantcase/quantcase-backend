...
const LENS_CONFIGS = [
  ...
  // ── Deal lenses ──────────────────────────────────────────────────────────────
  {
    ...
    config: {
      ...
      weights: [
        ...
        { metric: 'EPS_BASIC',     w: 0.30, b: 0 },
        { metric: 'EPS_DILUTED',   w: 0.25, b: 0 },
        { metric: 'EBITDA',        w: 0.20, b: 0 },
  ...
  },
  {
    ...
    config: {
      ...
      weights: [
        { metric: 'EPS_BASIC',     w: 0.40, b: 0 },
        { metric: 'EPS_DILUTED',   w: 0.30, b: 0 },
        { metric: 'PAT',           w: 0.20, b: 0 },
        { metric: 'ROE',           w: 0.15, b: 0 },
        { metric: 'ROCE',          w: 0.15, b: 0 },
        { metric: 'EBITDA_MARGIN', w: 0.10, b: 0 },
      ],
      aggregation:     'weighted_sum',
      model:           HAIKU,
      max_tokens:      MAX_TOKENS,
